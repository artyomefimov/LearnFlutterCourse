...
class MyCountPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    var state = Provider.of<CountProvider>(context);
    return Scaffold(
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            ...
            SizedBox(height: 50),
            Text("${state.counterValue}", style: Theme
                .of(context)
                .textTheme
                .headline4),
            ButtonBar(
                ...
                Consumer<CountProvider>(
                  builder: (context, provider, child) {
                    return IconButton(
                      icon: Icon(Icons.add),
                      color: Colors.green,
                      onPressed: () => provider._incrementCount(),
                    );
                  },
                ),
              ],
  ...
  Widget build(BuildContext context) {
    return Column(
      children: <Widget>[
        ...
        Consumer(
          builder: (context, List<User> users, child) {
            return Expanded(
              child: users == null ?
...
class MyEventPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    var provider = Provider.of<int>(context);
    return Container(
        child: Center(
            child: Column(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                ...
                SizedBox(height: 50),
                Text("${provider.toString()}", style: Theme
                    .of(context)
                    .textTheme
                    .headline4)
              ],
